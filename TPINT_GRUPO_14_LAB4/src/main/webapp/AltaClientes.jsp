...
<% 
 ...
 %>
    ...
    <div class="sidebar">
        ...
        <a href="ServletAlta" class="menu-item active">Alta de usuarios</a>
        ...
        <div class="content-area">
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <p class="section-subtitle">Complete el formulario para crear un nuevo cliente y su cuenta bancaria</p>
                </div>

                <!-- Mensajes de éxito/error -->
                <% if(request.getAttribute("exito") != null) { %>
                    <div class="alert alert-success">
                        ✅ Cliente y cuenta creados exitosamente. El cliente puede acceder al sistema.
                    </div>
                <% } %>
                ...
                <div class="form-note">
                    ...
                    Al crear un cliente se generará automáticamente su primera cuenta bancaria con saldo inicial de $10.000
                </div>
                ...
                <form method="post" action="ServletAlta">
                    ...
                    <div class="form-container">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                <label for="tipoUsuario" class="form-label">Tipo de usuario <span class="required">*</span></label>
                        ...
                        <div class="two-column">
                            <div class="form-group">
                                ...
                                <div class="password-strength">Mínimo 6 caracteres, use letras y números</div>
                            </div>
                            <div class="form-group">
                                <label for="password2" class="form-label">Repetir Contraseña <span class="required">*</span></label>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nacionalidad" name="nacionalidad" class="form-control" required 
                                       placeholder="Ej: Argentina" value="Argentina">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="button-group">
                        <button type="submit" name="alta" value="altaUsuario" class="btn btn-success">
                            ✅ Crear Cliente
                        </button>
                    </div>
                </form>
